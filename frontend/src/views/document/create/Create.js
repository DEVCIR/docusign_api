...
const Create = () => {
  ...
  // useEffect( () =>
  // {
  //   console.log( 'muneeb ate rice 10 plates', pageNumber )

  // }, [ pageNumber ] )
  // useEffect( () =>
  // {
  //   if ( !uploadedFile || !pdfPages.length || !containerRef.current ) return;
  ...
  //   if ( canvases.length === 0 ) return; // Ensure canvases exist

  //   canvases.forEach( ( canvas, index ) =>
  //   {
  //     console.log( 'this is canvas', canvas, index );
